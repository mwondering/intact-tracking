"""Train Memory350 with approximately twice the context parameters, from scratch."""
...
def _run(args: argparse.Namespace, distributed: DistributedContext) -> Path:
    ...
    run_config["method"] = "nominal-supervised Memory350 doubled context attention depth v1"
