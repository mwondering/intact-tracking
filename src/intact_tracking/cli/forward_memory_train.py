"""Train the separate short50/chunk10/long30 nominal-supervised context version."""
...
from intact_tracking.memory350_rollout import Memory350TrackerRollout as FixedDRTrackerRollout
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.set_defaults(num_envs=8192, validation_worlds=128, seed=717,
                        nominal_fraction=0.0, payload=False, tracker_dr_plus_limb_payload=True,
...
def _run(args: argparse.Namespace, distributed: DistributedContext) -> Path:
    ...
    run_config["method"] = "nominal-supervised hierarchical short50/chunk10/long30 context v1"
